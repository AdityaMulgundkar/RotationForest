...
statesWithFault = np.array(stMain)
## PLOT RESULTS
t = np.array(t)
...
while i < (timePeriod*frequency):
    y = DOP853(hex_dynamics2,tspan[0],stINIT,tspan[1])
    y.step()
    states = np.round(y.y, 4)
    allStates.append(states)
    t = tspan[1]
...
statesWithoutFault = np.array(stMain)
## PLOT RESULTS
t = np.array(t)
...
states = statesWithFault

v = (np.degrees(states[:,3]))
plt.subplot(2,4,1)
plt.plot(t,v)
w  = (np.degrees(statesWithoutFault[:,3]))
plt.plot(t,w)
plt.axvline(x = 2, color = 'r')
plt.axvline(x = 2.25, color = 'g')
minScale = (max(v) - min(v))*0.1
plt.ylim([min(v)-minScale, max(v)+minScale])
plt.title(r'$\phi$')
plt.legend([r'$\phi$ with proposed FDI + FTC', r'$\phi$ after immediate CA', 'Fault Introduced', 'Fault Corrected'])
plt.xlabel('Time (s)')
plt.ylabel('Angle (deg)')

v = (np.degrees(states[:,4]))
plt.subplot(2,4,2)
plt.plot(t,v)
w  = (np.degrees(statesWithoutFault[:,4]))
plt.plot(t,w)
plt.axvline(x = 2, color = 'r')
plt.axvline(x = 2.25, color = 'g')
minScale = (max(v) - min(v))*0.1
plt.ylim([min(v)-minScale, max(v)+minScale])
plt.title(r'$\theta$')
plt.legend([r'$\theta$ with proposed FDI + FTC', r'$\theta$ after immediate CA', 'Fault Introduced', 'Fault Corrected'])
plt.xlabel('Time (s)')
plt.ylabel('Angle (deg)')

v = np.divide(np.degrees(states[:,5]),2)
plt.subplot(2,4,3)
plt.plot(t,v)
w  = np.divide(np.degrees(statesWithoutFault[:,5]),2)
plt.plot(t,w)
plt.axvline(x = 2, color = 'r')
plt.axvline(x = 2.25, color = 'g')
minScale = (max(v) - min(v))*0.1
plt.ylim([min(v)-minScale, max(v)+minScale])
plt.title(r'$\psi$')
plt.legend([r'$\psi$ with proposed FDI + FTC', r'$\psi$ after immediate CA', 'Fault Introduced', 'Fault Corrected'])
plt.xlabel('Time (s)')
plt.ylabel('Angle (deg)')

plt.subplot(2,4,4)
invZ = (-1.*states[:,2])
invZ2 = (-1.*statesWithoutFault[:,2])
plt.plot(t,invZ)
plt.plot(t,invZ2)
plt.axvline(x = 2, color = 'r')
plt.axvline(x = 2.25, color = 'g')
...
plt.title('z')
plt.legend(['z with proposed FDI + FTC', 'z after immediate CA', 'Fault Introduced', 'Fault Corrected'])
plt.xlabel('Time (s)')
plt.ylabel('Height (m)')

v = (np.degrees(states[:,9]))
plt.subplot(2,4,5)
plt.plot(t,v)
w  = (np.degrees(statesWithoutFault[:,9]))
plt.plot(t,w)
plt.axvline(x = 2, color = 'r')
plt.axvline(x = 2.25, color = 'g')
minScale = (max(v) - min(v))*0.1
plt.ylim([min(v)-minScale, max(v)+minScale])
plt.title('p')
plt.legend(['p with proposed FDI + FTC', 'p after immediate CA', 'Fault Introduced', 'Fault Corrected'])
plt.xlabel('Time (s)')
plt.ylabel('Angular Velocity (deg/s)')

v = (np.degrees(states[:,10]))
plt.subplot(2,4,6)
plt.plot(t,v)
w  = (np.degrees(statesWithoutFault[:,10]))
plt.plot(t,w)
plt.axvline(x = 2, color = 'r')
plt.axvline(x = 2.25, color = 'g')
minScale = (max(v) - min(v))*0.1
plt.ylim([min(v)-minScale, max(v)+minScale])
plt.title('q')
plt.legend(['q with proposed FDI + FTC', 'q  after immediate CA', 'Fault Introduced', 'Fault Corrected'])
plt.xlabel('Time (s)')
plt.ylabel('Angular Velocity (deg/s)')

v = np.divide(np.degrees(states[:,11]),2)
plt.subplot(2,4,7)
plt.plot(t,v)
w  = np.divide(np.degrees(statesWithoutFault[:,11]),2)
plt.plot(t,w)
plt.axvline(x = 2, color = 'r')
plt.axvline(x = 2.25, color = 'g')
minScale = (max(v) - min(v))*0.1
plt.ylim([min(v)-minScale, max(v)+minScale])
plt.title('r')
plt.legend(['r with proposed FDI + FTC', 'r  after immediate CA', 'Fault Introduced', 'Fault Corrected'])
plt.xlabel('Time (s)')
plt.ylabel('Angular Velocity (deg/s)')

plt.subplot(2,4,8)
invW = (-1.*states[:,8])
invW2 = (-1.*statesWithoutFault[:,8])
plt.plot(t,invW)
plt.plot(t,invW2)
plt.axvline(x = 2, color = 'r')
plt.axvline(x = 2.25, color = 'g')
...
plt.title('w')
plt.legend(['w with proposed FDI + FTC', 'w after immediate CA', 'Fault Introduced', 'Fault Corrected'])
plt.xlabel('Time (s)')
